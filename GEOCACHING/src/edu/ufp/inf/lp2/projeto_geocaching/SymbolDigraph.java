...
public class SymbolDigraph {
     ...
     */
    /*
    public SymbolDigraph(BST_Aed2<Integer, Student> studentST, String filename, String delimiter) {
        st = new ST<>();
        ...
        while (in.hasNextLine()) {
            ...
            for (int i = 1; i < a.length; i = i+cost+1) {
                ...
                int comum = Integer.parseInt(a[i+1]);
                Ligacao d = new Ligacao(v, w, comum);
                System.out.println(studentST.get(v).getName() + "->" + studentST.get(w).getName());
                graph.addEdge(d);
            }
        }
    }
